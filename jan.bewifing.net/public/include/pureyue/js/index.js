    ...
    e("data/jigsawGame", function(e, t, n) {
        n.exports = [{
            ...
            ka: [{
                ...
                id: "1",
                pic: [{
                    img: "/include/pureyue/images/spell1.jpg",
                    row: 2,
                    column: 2
                }]
            }, {
                ...
                pic: [{
                    ...
                    img: "/include/pureyue/images/spell2.jpg",
                    row: 4,
					type: 2,
                    second: 99999,
                    column: 4
                },{
                    img: "/include/pureyue/images/spell3.jpg",
                    row: 5,
                    type: 2,
                    second: 99999,
                    column: 5
        ...
        p.init = function(e) {
            ...
            e.html(t), p.jigsawGame = s, p.jigsawGame.init(e), p.dom = e, p.jigsawGame.on("picOver", function(e) {
				var str="恭喜您挑战成功<br>共闯过了<em>"+(p.currentGame.pic+1)+"</em>关";
                var score = p.currentGame.pic+1;
                $.ajax({
                    type: "POST",
                    url: "/ci/pureyue/updatePuzzleScore",
                    data: { score:score },
                    dataType: "json",
				...
				showGameResult("挑战失败<br>共闯过了<em>"+(p.currentGame.pic)+"</em>关",false,p.hasNextPic()); 
            })
