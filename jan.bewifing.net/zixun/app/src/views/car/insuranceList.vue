    ...
    <div class="row">
      <div class="row-up clearfix">
        ...
        <div class="row-up-right">
          <div class="row-text"><span>投保限额:200万</span><span class="margin-l02">保险费率:0.02%</span></div>
      ...
      <div class="row-bottom">
        <div class="btn-insure" @click="gotoInsuranceDetail">立即投保</div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    gotoInsuranceDetail () {
      return this.$router.push({path: prefixUrl + '/insuranceDetail', query: {}})
    },
    updateFun () { // 更新数据
      // var self = this
